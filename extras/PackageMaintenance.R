...
OhdsiRTools::checkUsagePackage("XLHDataPrediction")
OhdsiRTools::updateCopyrightYearFolder()

# Create manual -----------------------------------------------------------
shell("rm extras/XLHDataPrediction.pdf")
shell("R CMD Rd2pdf ./ --output=extras/XLHDataPrediction.pdf")
...
OhdsiRTools::insertEnvironmentSnapshotInPackage("XLHDataPrediction")
